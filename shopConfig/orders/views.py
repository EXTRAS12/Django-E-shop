...
def basket_adding(request):
    ...
    if is_delete == 'true':
        ...
        new_product, created = ProductInBasket.objects. \
            get_or_create(session_key=session_key, product_id=product_id, is_active=True,
                          defaults={"nmb": nmb})
        if not created:
            print("not created")
    ...
    products_in_basket = ProductInBasket.objects. \
        filter(session_key=session_key, is_active=True, order__isnull=True)
